...
public interface _IDateConverter2 extends ota.client12._IDateConverter {
  // Methods:
  /**
   * <p>
  ...
  @VTID(5)
  java.lang.String convertVisualToLogicalDateType(
    int fieldType,
  ...
  @VTID(6)
  java.lang.String convertLogicalToVisualDateType(
    int fieldType,
    boolean skipEqualityInVerification,
