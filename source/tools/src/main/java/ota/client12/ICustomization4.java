...
public interface ICustomization4 extends ota.client12.ICustomization3 {
  // Methods:
  /**
   * <p>
   ...
   * </p>
   * @return  Returns a value of type ota.client12.ICustomizationEntityAttributes
   */

  @DISPID(22) //= 0x16. The runtime will prefer the VTID if present
  @VTID(28)
  ota.client12.ICustomizationEntityAttributes entityAttributes();
   ...
   * </p>
   * @return  Returns a value of type ota.client12.ICustomizationRelations
   */

  @DISPID(23) //= 0x17. The runtime will prefer the VTID if present
  @VTID(29)
  ota.client12.ICustomizationRelations relations();
  ...
  @VTID(31)
  ota.client12.IList supportsMultivalueEntitiesTables();
  ...
  @VTID(32)
  ota.client12.IList supportsQPMKPITypesEntitiesTables();
  ...
  @VTID(33)
  ota.client12.IList supportsHistoryEntitiesTables();
  ...
  @VTID(34)
  ota.client12.IList supportWorkflowEntitiesTables();
   ...
   * </p>
   * @return  Returns a value of type ota.client12.ICustomizationUser
   */

  @DISPID(31) //= 0x1f. The runtime will prefer the VTID if present
  @VTID(37)
  ota.client12.ICustomizationUser loggedInUser();
  ...
  @VTID(38)
  ota.client12.IList supportsDataHidingFilterEntitiesTables();
