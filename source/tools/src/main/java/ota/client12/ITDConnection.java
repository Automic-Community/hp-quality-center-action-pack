...
public interface ITDConnection extends Com4jObject {
  ...
  @VTID(16)
  ota.client12.IList userGroupsList();
  ...
  /**
   * <p>
   * Obsolete. Accessing this property throws an exception.
   * </p>
   * <p>
  ...
  @VTID(23)
  ota.client12.IList projectsList();
  ...
  @VTID(60)
  ota.client12.IList projectsListEx(
    java.lang.String domainName);
  ...
  @VTID(62)
  ota.client12.IList domainsList();
