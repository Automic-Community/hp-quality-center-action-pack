...
public interface IReqFactory5 extends ota.client12.IReqFactory4 {
  // Methods:
  /**
   * <p>
   ...
   * @param relationSettings Mandatory ota.client12.IList parameter.
   * @param statistics Mandatory Holder<ota.client12.IList> parameter.
   * @param rows Mandatory Holder<ota.client12.IList> parameter.
   * @return  Returns a value of type ota.client12.IList
   */

  @DISPID(31) //= 0x1f. The runtime will prefer the VTID if present
  @VTID(39)
  ota.client12.IList calculateTraceabilityMatrix(
    java.lang.String filter,
    ota.client12.IList relationSettings,
    Holder<ota.client12.IList> statistics,
    Holder<ota.client12.IList> rows);
   ...
   * @param filter Mandatory java.lang.String parameter.
   * @return  Returns a value of type ota.client12.ITraceabilityMatrixRelationSettings
   */

  @DISPID(32) //= 0x20. The runtime will prefer the VTID if present
  @VTID(40)
  ota.client12.ITraceabilityMatrixRelationSettings createTraceabilityMatrixRelationSettings(
  ...
  @VTID(42)
  ota.client12.IList getAllLinkedEntities(
    java.lang.String reqIDs,
    ota.client12.IList relationSettings);
  ...
  @VTID(44)
  ota.client12.IList getCoverageTestConfigsByReqFilter(
