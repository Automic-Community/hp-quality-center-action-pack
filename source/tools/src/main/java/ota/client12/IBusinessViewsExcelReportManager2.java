...
public interface IBusinessViewsExcelReportManager2 extends ota.client12.IBusinessViewsExcelReportManager {
  // Methods:
  /**
   * <p>
  ...
  @VTID(23)
  java.lang.String getExecutionTaskDetails(
    int taskID);
  ...
  @VTID(24)
  java.lang.String getRemoteExecutionTaskDetails(
    int taskID,
    java.lang.String projectId);
  ...
  @VTID(27)
  java.lang.String getDqlExecutionMetadata(
