...
public interface IBusinessProcess4 extends ota.client12.IBusinessProcess3 {
  // Methods:
  /**
   * <p>
   ...
   * </p>
   * @param testParamIdsList Mandatory ota.client12.IList parameter.
   * @return  Returns a value of type ota.client12.IList
   */

  @DISPID(135) //= 0x87. The runtime will prefer the VTID if present
  @VTID(83)
  ota.client12.IList getBPIterParamsUsingTestParameters(
    ota.client12.IList testParamIdsList);
