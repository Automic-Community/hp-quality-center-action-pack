...
public interface IComparisonNode extends ota.client12.IBaseFieldEx {
  // Methods:
  /**
   * <p>
  ...
  @VTID(31)
  ota.client12.IComparisonNode nextChange();
  ...
  @VTID(32)
  ota.client12.IComparisonNode prevChange();
