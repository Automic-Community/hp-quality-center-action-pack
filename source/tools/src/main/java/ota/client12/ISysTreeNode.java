...
public interface ISysTreeNode extends Com4jObject {
   ...
   * @return  Returns a value of type ota.client12.ISysTreeNode
   */

  @DISPID(1) //= 0x1. The runtime will prefer the VTID if present
  @VTID(9)
  ota.client12.ISysTreeNode addNode(
  ...
  @VTID(13)
  ota.client12.ISysTreeNode findChildNode(
  ...
  @VTID(15)
  ota.client12.ISysTreeNode father();
  ...
  @VTID(16)
  ota.client12.ISysTreeNode child(
    int index);
  ...
  @VTID(19)
  ota.client12.IList findChildren(
