...
public interface IBPComponent2 extends ota.client12.IBPComponent {
  // Methods:
  /**
   * <p>
  ...
  @VTID(40)
  ota.client12.IList getPrecedingOutputBpParameters();
  ...
  @VTID(43)
  ota.client12.IList inBPParamsIdsWithIterationsMismatch();
