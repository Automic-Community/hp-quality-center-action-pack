...
public interface ILibrary extends ota.client12.IBaseFieldExMail {
  // Methods:
  /**
   * <p>
   ...
   * </p>
   * @param srcLibrary Mandatory ota.client12.ILibraryInfo parameter.
   * @param srcBaselineId Mandatory int parameter.
   * @param comparisonId Mandatory int parameter.
   * @param fieldsToSync Mandatory ota.client12.IList parameter.
   * @return  Returns a value of type int
   */
  ...
  @VTID(33)
  int beginSync(
    ota.client12.ILibraryInfo srcLibrary,
    int srcBaselineId,
    int comparisonId,
    ota.client12.IList fieldsToSync);
  ...
  @VTID(35)
  ota.client12.ILibraryOperationResult createBaselineVerification();
  ...
  @VTID(36)
  ota.client12.ILibraryOperationResult syncLibrariesVerification(
    ota.client12.ILibraryInfo srcLibrary,
    int srcBaselineId,
    int comparisonId);
