...
public interface ICustomizationField2 extends ota.client12.ICustomizationField {
  // Methods:
  /**
   * <p>
  ...
  @VTID(75)
  ota.client12.IList authorizedModifyForGroups();
  ...
  @VTID(78)
  ota.client12.IList authorizedOwnerSensibleForGroups();
  ...
  @VTID(81)
  ota.client12.IList authorizedVisibleInNewBugForGroups();
  ...
  @VTID(84)
  ota.client12.IList authorizedVisibleForGroups();
