...
public interface IBusinessProcess2 extends ota.client12.IBusinessProcess {
  // Methods:
  /**
   * <p>
  ...
  @VTID(65)
  ota.client12.IList flowOutputParameters();
  ...
  @VTID(72)
  ota.client12.IList getParameterGroups(
    int groupLevel);
  ...
  @VTID(73)
  ota.client12.IList getRTParamOccurrences(
